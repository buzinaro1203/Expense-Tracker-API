...
RF05 - O sistema deve permitir ao usuário adicionar um limite de despesas.
...
RN03 - Uma despesa deve possuir valor, data, categoria e pode possuir descrição.
RN04 - O limite de despesas deve possuir valor maior que zero.
RN05 - O limite de despesas deve possuir data de início e data de fim.
...
RN08 - Uma renda deve possuir valor, data, categoria e pode possuir descrição.
...
### Categorias
RN11 - Uma categoria deve possuir nome, descrição e tipo (renda ou despesa).
